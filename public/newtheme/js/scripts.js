...
$(".location a , .loc-act").on("click", function (e) {
    e.preventDefault();
    // $.get("https://www.googleapis.com/geolocation/v1/geolocate?key=AIzaSyCFgomoZjQBBtXSX8yNGTXi2E0YZHkig_s", function (response) {
...
function showPosition(position) {
    ...
    var longlitude = position.coords.longitude;

    var Address = GetAddress(latitude,longlitude);
