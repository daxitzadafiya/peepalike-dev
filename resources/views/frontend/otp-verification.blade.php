        ...
        <div class="page-contant-inner">
            ...
            <div class="login-form">
                ...
                <div class="login-form-left">
                    <form action="{{ route('verify.otp') }}" class="form-signin" method = "post" id="login_box" >
                        <input type="hidden" name="id" id="id" value="{{ $uid }}">
                        <input type="hidden" name="type" id="type" value="{{ $type }}">
                        <b>
                            <label>Verification code</label>
                            <input name="otp" id="otp" type="number" placeholder="OTP" class="login-input" value="" required />
                        </b>
                        <b>
                            <input type="button" onclick="verifyOtp()" class="submit-but" value="Verify" />
