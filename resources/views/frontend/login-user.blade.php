        ...
        <div class="page-contant-inner">
            ...
            <div class="login-form">
                ...
                <div class="login-form-left">
                    <form action="{{ route('users.login') }}" class="form-signin" method="post"
                          id="login_box">
                          @csrf
                        <b>
                            <label>Email</label>
                            <input name="email" type="text" placeholder="Enter Email"
                                   class="login-input" id="vEmail" required/></b>
                        <b>
                ...
                <div class="login-form-right login-form-right1">
                    <div class="login-form-right1-inner">
                        ...
                        <span><a class="company" href="{{ route('user.register') }}">SIGN UP</a></span>
                    </div>
                    <div class="login-form-right1-inner">
