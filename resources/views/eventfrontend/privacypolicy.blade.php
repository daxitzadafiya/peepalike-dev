...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontendassets/css/entrepreneurship.css') }}"> <!--===== style.css link =====-->
    <!--== site title ==-->
    <title>Booking</title>
    <!--== favicon ==-->
    <link rel="icon" href="assets/favicon/favicon.png" type="icon/ico" sizes="48x48">
</head>
<body>
    <div class="wrapper"> 
    <!--========== full content wrapper start ==========-->
        <header class="header entrepreneurship_header"> 
          <!--========== header start ==========-->
                            ...
                            <div class="discription_text_box"> <!--========== discription text box start ==========-->
                                ...
                                <div class="discription_text_box_body">
                                    <p>
                                        ...
                                        <li>
                                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Peepalike.</p>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                        <p><strong>Website</strong> refers to Peepalike, accessible from <a href="http://peepalike.com/" rel="external nofollow noopener" target="_blank">https://peepalike.com/</a></p>
                                        </li>
                                        <li>
                                        ...
                                        <ul>
                                        <li>By email: info@peepalike.com</li>
                                        </ul>
                                    </p>
                                </div>
    ...
    <script type="text/javascript" src="{{ asset('frontendassets/js/entrepreneurship.js') }}"></script>
</body>
</html>