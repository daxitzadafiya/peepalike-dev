                        ...
                        <div class="box-widget widget-posts blog-widgets">
                            <div class="card user-card">
                                ...
                                <div class="card-block">
                                    ...
                                    <h6 class="f-w-600 m-t-25 m-b-10">{{ $item->first_name }}</h6>
                                    <p class="text-muted"> {{ $item->gender }} </p>
                                    <hr>
                                     
                                    <div class="bg-c-green counter-block m-t-10 p-20">
                                        <div class="row">
                                            
                                          <i class="fa fa-envelope"></i><span> {{ $item->email }}</span>
                                    ...
                                    {{-- <div class="row justify-content-center user-social-link">
                                        <div class="col-auto"><a href="#!"><i class="fa fa-facebook text-facebook"></i></a><a href="#!"><i class="fa fa-twitter text-twitter"></i></a>  <a href="#!"><i class="fa fa-linkedin text-linkedin"></i></a></div>
                                    </div> --}}
                                </div>
                            </div>
