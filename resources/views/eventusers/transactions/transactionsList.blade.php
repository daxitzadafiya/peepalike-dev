        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0" style="width: 80%; float: left;">Transactions List</h3>
                      ...
                      @foreach($TransactionsList as $key => $value)
                          ...
                          <tr>
                            ...
                            <td style="width: 125px;">
                              <!-- <a href="#" class="btn btn-xs btn-primary" data-id="{{ $value->id }}" title="Edit"><span class="fa fa-edit"></span></a>
                              <button type="button" class="btn btn-xs btn-danger delete_ticket11" data-did="{{ $value->id }}" title="Delete"><span class="fa fa-trash"></span></button> -->
                            </td>
                          </tr>
                      @endforeach
                  @else
