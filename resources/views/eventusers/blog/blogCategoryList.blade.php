        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0" style="width: 80%; float: left;">Blog Category List</h3>
              <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#add_category">&nbsp; Add Blog Category</button>
            </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ url('/eventuser/blog/insertCategory') }}" method="post" id="add_category_form" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="row">
                      <div class="col-md-12">
                          <fieldset>
...
<div class="modal fade" id="edit_category" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ url('/eventuser/blog/updateCategory') }}" method="post" id="edit_category_form" enctype="multipart/form-data">
                  {!! csrf_field() !!}
                  <div class="row">
                      <div class="col-md-12">
                          <fieldset>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('/eventuser/blog/deleteCategory') }}" method="post">
                  {{ csrf_field() }}
