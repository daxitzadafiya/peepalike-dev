        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0" style="width: 80%; float: left;">Hangout List</h3>
                      ...
                      @foreach($groupList as $key => $value)
                          ...
                          <tr>
                            <td style="width: 125px;">
                              <a href="{{ url( '/eventuser/eventTicket/'.$value->id )}}" class="btn btn-xs btn-primary" data-tid="{{ $value->id }}" title="Chat View"><i class="fas fa-eye"></i></a>
                            ...
                            <td>{{ $value->expired_date_time }}</td>
                            <td>{{ $value->address_line_1 }}</td>
                            <td>
                              <label class="switch">
                                  <input class="switch-input eisactive11" type="checkbox" id="event_status_{{ $value->id }}" name="event_status" data-id="{{ $value->id }}" @if($value->status == '0') {{ 'checked' }} @endif>
