        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0" style="width: 80%; float: left;">Event Benner List</h3>
              <a href="{{ url( '/eventuser/addBenner/'.$id )}}" class="btn btn-info pull-right" style="color: white;"><span class="fa fa-plus"></span>&nbsp; Add Benner</a>
            </div>
                      ...
                      @foreach($eventBennerList as $key => $value)
                          <tr>
                            ...
                            <td style="width: 125px;">
                              <a href="{{ url( '/eventuser/editBenner/'.$value->id )}}" class="btn btn-xs btn-primary" data-id="{{ $value->id }}" title="Edit"><span class="fa fa-edit"></span></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want remove this benner ?</p>
                <form action="{{ url('/eventuser/deleteBenner') }}" method="post">
                  {{ csrf_field() }}
