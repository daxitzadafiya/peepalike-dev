        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0" style="width: 80%; float: left;">Event Ticket List</h3>
              <a href="{{ url( '/eventuser/addTicket/'.$id )}}" class="btn btn-info pull-right" style="color: white;"><span class="fa fa-plus"></span>&nbsp; Add Ticket</a>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-basic">
                ...
                <tbody>
                  @if(!empty($eventTicketList))
                      @foreach($eventTicketList as $key => $value)
                          ...
                          <tr>
                            ...
                            <td>{{ $value->maximum_quantity }}</td>
                            <td>
                              <label class="switch">
                                  <input class="switch-input eisactive" type="checkbox" id="event_status_{{ $value->id }}" name="event_status" data-id="{{ $value->id }}" @if($value->visibility == 'visible') {{ 'checked' }} @endif>
                                  <span class="switch-label" data-on="Visible" data-off="Hidden"></span>
                                  <span class="switch-handle"></span>
                              </label>
                            </td>
                            <td style="width: 125px;">
                              <a href="{{ url( '/eventuser/editTicket/'.$value->id )}}" class="btn btn-xs btn-primary" data-id="{{ $value->id }}" title="Edit"><span class="fa fa-edit"></span></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want remove this Ticket ?</p>
                <form action="{{ url('/eventuser/deleteTicket') }}" method="post">
                  {{ csrf_field() }}
