        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0" style="width: 80%; float: left;">Premium List</h3>
              <a href="{{ route('admin.addPremium') }}" class="btn btn-info pull-right" style="color: white;"><span class="fa fa-plus"></span>&nbsp; Add Premium</a>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-basic">
                ...
                <tbody>
                  @if(!empty($EventPremiumList))
                      @foreach($EventPremiumList as $key => $value)
                          ...
                          <tr>
                            ...
                            <td style="width: 125px;">
                              ...
                              <a href="{{ url( '/eventuser/editPremium/'.$value->id )}}" class="btn btn-xs btn-primary" data-id="{{ $value->id }}" title="Edit"><span class="fa fa-edit"></span></a>
                              <button type="button" class="btn btn-xs btn-danger delete_premium" data-did="{{ $value->id }}" title="Delete"><span class="fa fa-trash"></span></button>
                            </td>
                          </tr>
                      @endforeach
                  @else
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want remove this premium ?</p>
                <form action="{{ url('/eventuser/deletePremium') }}" method="post">
                  {{ csrf_field() }}
    ...
    <div class="modal-dialog">
        <div class="modal-content modal-md">
            ...
            <div class="modal-body card-box">
                <p>Are you sure you want to this premium use inactive?</p>
                <form action="{{ url('/eventuser/inactivePremium') }}" method="post">
                  {{ csrf_field() }}
...
<div id="activeModal" class="modal fade" tabindex="0" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content modal-md">
            ...
            <div class="modal-body card-box">
                <p>Are you sure you want to this premium use active?</p>
                <form action="{{ url('/eventuser/activePremium') }}" method="post">
                  {{ csrf_field() }}
