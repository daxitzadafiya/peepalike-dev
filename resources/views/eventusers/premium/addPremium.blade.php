          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Add Premium </h3>
                </div>
               
              </div>
            </div>
            <div class="card-body">
              <form action="{{ url('/eventuser/insertPremium') }}" method="post" >
                {{ csrf_field() }}
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" id="plan_name" name="plan_name" class="form-control" placeholder="Premium Name" required="">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">Premium Price ($)</label>
                        <input type="text" id="price" name="price" class="form-control" placeholder="Price" min="0" max="500" required="">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
