        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0" style="width: 80%; float: left;">User Status List</h3>
              <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#add_status">&nbsp; Add Status</button>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-basic">
                ...
                <tbody>
                  @if(!empty($EventUserStatusList))
                      @foreach($EventUserStatusList as $key => $value)
                          <tr>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ url('/eventuser/insertUserStatus') }}" method="post" id="add_status_form">
                  {{ csrf_field() }}
                  <div class="row">
                      <div class="col-md-12">
                          <fieldset>
                              <div class="form-group">
                                  ...
                                  <div class="col-md-12">
                                     <input type="text" name="user_status" id="user_status" class="form-control" placeholder="Status Name"required="">
                                  </div>
                              </div>
                          </fieldset>
                      </div>
